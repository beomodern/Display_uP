...
#define DISP_RST_0_PS		(DISP_RST__0__PS)
#define DISP_RST_0_PC		(DISP_RST__0__PC)
#define DISP_RST_0_DR		(DISP_RST__0__DR)
#define DISP_RST_0_SHIFT	(DISP_RST__0__SHIFT)
#define DISP_RST_0_INTR	((uint16)((uint16)0x0003u << (DISP_RST__0__SHIFT*2u)))
